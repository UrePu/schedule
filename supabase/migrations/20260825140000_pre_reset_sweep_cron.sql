...
--
-- ───────────────────────────────────────────────────────────────────────────────
-- ★ 적용 뒤 vault 비밀 두 개가 필요하다 — 값은 이 파일에 적을 수 없다
-- ───────────────────────────────────────────────────────────────────────────────
...
-- 저장소에 평문 비밀이 커밋된다.
--
-- ✅ 운영 프로젝트(hryikreaxngexhjjxfyl)에는 2026-08-25 에 둘 다 등록했고, 배관을 손으로
--    한 번 돌려 **HTTP 200 · synced 24 · failed 0** 을 확인했다. 다른 환경에 올릴 때만
--    위 두 줄이 필요하다.
