...
```
19:00 1파티 하드 스우 (우레푸, 라이언, 어피치, 프로도)
8/20(목) 19:30 2파티 하드 스우 (우레푸, 라이언, 어피치, 프로도 …외 3명)
```
...
| 항목 | 결과 |
|---|---|
| 알림 문구 | `19:00 1파티 하드 스우 (우레푸, 라이언, 어피치, 프로도)` — 시각 표기는 2026-08-19 에 `19시` → `19:00` 으로 바뀌었다(마이그레이션 `20260819120000`) |
| 7명 잘림 / 다른 날짜 | `… …외 3명` / `8/20(목) 19:00 …` |
