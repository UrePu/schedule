...
- **결정석 시세는 여전히 미상(null)이다.** 공개 가격표에 없다(`review-BOSS-DATA.md` L96).
  D4 에 따라 0 이 아니라 미상으로 두고, 수익 합계에서 빠지며 "가격 미상 N건" 으로 세어진다.
  확인되면 **새 효력 시각의 행을 얹는다** — 기존 null 행은 지우지 않는다(R3).
