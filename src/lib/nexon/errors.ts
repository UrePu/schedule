...
const KIND_MESSAGE: Record<NexonErrorKind, string> = {
  invalid_key:
    "넥슨 API 키가 유효하지 않습니다. 키를 다시 확인하거나 새로 발급해 주세요.",
  quota_exceeded:
    "넥슨 API 호출 한도를 초과했습니다. 잠시 후 다시 시도해 주세요.",
  invalid_parameter:
    "넥슨 API 가 요청을 거절했습니다. 캐릭터명이나 조회 날짜를 확인해 주세요.",
  invalid_id:
    "캐릭터 식별자(ocid)가 유효하지 않습니다. 캐릭터 목록을 새로 불러와 주세요.",
  forbidden: "이 API 키로는 접근할 수 없는 요청입니다.",
  upstream_unavailable:
    "넥슨 API 가 일시적으로 응답하지 않습니다. 잠시 후 다시 시도해 주세요.",
  schema_mismatch:
    "넥슨 API 응답 형식이 예상과 다릅니다. 잠시 후 다시 시도해 주세요.",
  network: "넥슨 API 에 연결하지 못했습니다. 네트워크 상태를 확인해 주세요.",
  unknown: "넥슨 API 요청이 실패했습니다. 잠시 후 다시 시도해 주세요.",
};
